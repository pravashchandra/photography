            ...
            <div className='group cursor-pointer overflow-hidden'>
                <div className="relative">
                    {/* <Link href={service.path}> */}
                        <Image src={service.image}  alt='img_1' className='w-[200px] md:w-[300px] h-[110px] md:h-[162px] lg:h-[210px] object-cover transition-all duration-500 rounded-[50%] border border-lightgold-100 before:duration-500' />
                    {/* </Link> */}
