        ...
        return (
                ...
                <SwiperSlide className='justify-center items-center' key={data?.id}>
                    <div className='relative' >
                        <Image src={data?.bannerImage} alt='Wedding' className='hidden md:flex h-[630px] md:h-[100%] object-cover'/>
                        <Image src={data?.mobbannerImage} alt='Wedding' className='md:hidden w-[400px] h-[750px] md:h-[100%] object-cover'/>
                        
                        <div className='absolute left-[50%] md:left-[0%] translate-x-[-50%] md:translate-x-[0%] top-[20%] md:top-[40%] text-center md:text-left flex flex-col justify-center px-[0px] md:px-20 uppercase'>
                            {/* <h6 className='text-[#DDD187] font-josefin font-[300] text-[16px] tracking-[1px] md:tracking-[3px] mb-4 '>{slider.bannersubcontent}</h6> */}
                            <h1 className='text-white text-[22px] md:text-[42px] xl:text-[42px] w-[100%] md:w-[60%] font-coromont tracking-[2px] leading-[1.4em] md:leading-[1.6em] mb-6'>{data?.bannercontent}</h1>
                            <div className='mt-[0px] md:mt-8 m-auto md:ml-0'>
