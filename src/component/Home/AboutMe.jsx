    ...
    <>
      <div className='w-[100%] px-[24px] xl:px-20 pt-[50px] xl:pt-[70px] md:flex bg-[#FFECD8]' >
        <div className='w-[100%] md:w-[50%] xl:w-[50%] items-center md:pb-[50px] lg:pb-[0px]'>
          ...
          <h1 className='font-coromont text-[28px] md:text-[32px] lg:text-[35px] xl:text-[48px] mb-2 md:mb-2 leading-[1.3em] md:leading-[1.2em]' data-aos ='fade' data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600" data-aos-once="true" >My name is <span className='text-[#C48F56]'>Pradosh.</span></h1>
