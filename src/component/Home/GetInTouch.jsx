    ...
    <>
      <div className='w-full px-[24px] xl:px-20 pt-[50px] xl:pt-[60px] pb-[70px] md:flex gap-[60px]'>
        <div className='w-[100%] md:w-[50%] items-center'>
          <h2 className='font-coromont text-[30px] md:text-[32px] lg:text-[35px] xl:text-[45px]'>Get In Touch</h2>
          <p className='text-[15px] lg:text-[17px] mb-[15px] md:mb-[30px] xl:mb-[50px] w-[100%] md:w-[90%]'>
